...
const styles = StyleSheet.create({
  ...
  center: { gap: 12 },
  sanskrit: { ...Typography.sanskrit, fontSize: 28, lineHeight: 48 },
  english:  { ...Typography.chapterTitle, fontSize: 32 },
  sub:      { ...Typography.ui, fontSize: 14, marginTop: 4 },
  btn: {
    borderWidth: 1,
    paddingVertical: 14,
  ...
  btnText: { ...Typography.ui, fontSize: 14, letterSpacing: 1, textTransform: 'uppercase' },
});
